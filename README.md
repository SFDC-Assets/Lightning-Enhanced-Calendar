![GPLv2 License](https://img.shields.io/badge/license-GPLv2-success) ![Released](https://img.shields.io/badge/status-Released-success) ![Code Coverage](https://img.shields.io/badge/apex%20code%20coverage-97%25-success)
...
- Since the `filter` key of the `Objects` configuration variable is quite literally a [SOQL injection](https://developer.salesforce.com/docs/atlas.en-us.apexcode.meta/apexcode/pages_security_tips_soql_injection.htm), I take only minor defensive actions against SOQL injection. Please re-read the section below about how this code is meant to help my Salesforce colleagues do customer demonstrations as easily as they can and how this code, as delivered, is not ready or secured for production use. That's why it's licensed under the GPL license. By all means, take whatever steps necessary to secure it if you wish to deploy it to a production environment.
...
[Install the Package in Production](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tHu0000049dpQIAQ)

[Install the Package in a Sandbox](https://test.salesforce.com/packaging/installPackage.apexp?p0=04tHu0000049dpQIAQ)
